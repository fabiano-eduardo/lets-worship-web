// Icons component - simple inline SVG icons
...
export function IconMusic({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconPinOff({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M2 2l20 20M12 17v5M9 9v1.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24V17h12M15 6V4a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2" />
      <path d="M15 10.76V6" />
    </svg>
  );
}
...
export function IconSpotify({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconWifiOff({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M2 2l20 20M8.5 16.429a5 5 0 0 1 7 0M2 8.82a15 15 0 0 1 4.17-2.82M6.36 12.93a10 10 0 0 1 3.26-2.3" />
      <path d="M10.83 5.09A15 15 0 0 1 22 8.82M17.64 12.93a10 10 0 0 0-1.9-1.48" />
      <path d="M12 20h.01" />
    </svg>
  );
}
...
export function IconEyeOff({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconMaximize({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconMinimize({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconCloudOff({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
